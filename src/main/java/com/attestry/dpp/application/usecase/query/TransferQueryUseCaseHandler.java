...
public class TransferQueryUseCaseHandler implements TransferQueryUseCase {
        ...
        public TransferDetailsResult getTokenDetails(String tokenOrCode) {
                ...
                return TransferDetailsResult.builder()
                                ...
                                .status(transfer.getState() == TransferState.INITIATED ? "PENDING"
        ...
        @Transactional(readOnly = true)
        public TransferInitiateResult getActiveTransfer(String passportId) {
                return transferRepository.findFirstByPassportIdAndStateAndExpiresAtAfterOrderByExpiresAtDesc(
                                passportId, TransferState.INITIATED, java.time.LocalDateTime.now())
                                .map(t -> TransferInitiateResult.of(t.getId(), t.getCode(), t.getExpiresAt()))
                                .orElse(null);
        }
}
